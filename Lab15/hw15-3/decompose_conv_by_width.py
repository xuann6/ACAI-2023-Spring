...
def decomposeConvByWidth(onnx_model, limit):
        ...
        if node.op_type == 'Conv':
            ...
            if input_width > limit:
                ...
                if kernel_width - 1 == 0:
                    ...
                    sep_num = math.ceil(
                        output_width / (limit - kernel_width + 1))
                ...
                for attr in node.attribute:
                    if attr.name == 'pads':
                        ...
                        # ===============================================   WARNING  =========================================
                print("Separating node:", node.name)
                ...
                offset = 0
                useful_num = limit - kernel_width + 1
                ...
                for i in range(sep_num):
                    ...
                    slice_node = onnx.helper.make_node(
                        ...
                        ends=[input_shape[0], input_shape[1],
                              input_shape[2] + 2 * pad_num, offset + limit],
                        # ===============================================   TBD  ================================================
                    )
