...
class controller extends Module {
  ...
  val cacheAccessCounter = RegInit(0.U(13.W))
  val cacheReadHitCounter = RegInit(0.U(13.W))
  val cacheWriteHitCounter = RegInit(0.U(13.W))
  val cacheReadMissCounter = RegInit(0.U(13.W))
  val cacheWriteMissCounter = RegInit(0.U(13.W))
