...
class controller_4_way extends Module {
  ...
  // original 2-way description
  // val chosenWay = WireDefault(Mux(hit, (io.addr.bits(31,13)===io.tag(1)(18,0) && io.tag(1)(18)===1.U), !LRUTable(io.addr.bits(13,5))))
...
//每個st的回傳訊號
  switch(state) {
    ...
    */
      ...
      // 4-way Psudo-LRU replacement policy
      LRUTable(io.addr.bits(12,5)) := MuxLookup(chosenWay, "b000".U, Seq(
                                        "b000".U -> Cat(3.U(2.W),LRUTable(io.addr.bits(12,5))(0)),
                                        "b001".U -> Cat(2.U(2.W),LRUTable(io.addr.bits(12,5))(0)),
                                        "b010".U -> Cat(0.U(1.W),LRUTable(io.addr.bits(12,5))(1), 1.U(1.W)),
                                        "b011".U -> Cat(0.U(1.W),LRUTable(io.addr.bits(12,5))(1), 0.U(1.W)),
                                      ))

      // original 2-way replacement policy
      // LRUTable(io.addr.bits(13,5)) := chosenWay // chosenWay equals either 0 or 1
    }
    is(returndata) {
