...
class FIFO_AXITest(dut:top_AXI) extends PeekPokeTester(dut){
    ...
    /* (Hsuan) Lab 10_3 performance counter */
    ...
    println(s"[Mem_R_Stall_Count              ] ${"%8d".format(Mem_Read_Stall_Cycle_Count)}")
    println(s"[Mem_W_Stall_Count              ] ${"%8d".format(Mem_Write_Stall_Cycle_Count)}")
    println(s"[Mem_R_Count                    ] ${"%8d".format(Mem_Read_Request_Count)}")
    println(s"[Mem_W_Count                    ] ${"%8d".format(Mem_Write_Request_Count)}")
    println(s"[Mem_R_Bytes_Count              ] ${"%8d".format(Mem_Read_Bytes_Count)}")
    println(s"[Mem_W_Bytes_Count              ] ${"%8d".format(Mem_Write_Bytes_Count)}")

    // (Hsuan) Performance Analysis
    println("==============================================================")
...
object FIFO_AXITest extends App{
  Driver.execute(args,()=> new top_AXI){
    dut:top_AXI => new FIFO_AXITest(dut)
  }
}
